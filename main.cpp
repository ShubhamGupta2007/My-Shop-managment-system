...
void login()
{
    ...
    ch = _getch();
    int count1=0;
    while(count1 != 3){//character 13 is enter
      pass+=ch;
      cout << '*';
      ch = _getch();
      count1++;
...
void medicine()
{
	...
	do
	{
	  ...
	  gotoxy(34+35,3);
	   printf("---------------");
	  gotoxy(35+35,4);
	  printf("medicines Menu.");
	  gotoxy(34+35,5);
	  printf("---------------");
	  gotoxy(25+35,15);
	  printf("1.Purchase New medicines");

	  gotoxy(25+35,19);
	  printf("2.Sale medicines");

	  gotoxy(25+35,23);
	  printf("3.Stock of medicines");

	  gotoxy(25+35,27);
	  printf("4.Search medicines");
...
{  char c;
   ...
   do
   {
	...
	printf("***** BOOK STORE *****");
	gotoxy(10+35,8);
	printf("=> This Project Is About medicines Store ");
	gotoxy(10+35,10);
	printf("=> In This Project we Can Add medicines ,Customer,Supplier Details");
	gotoxy(10+35,12);
	printf("=> We Can Modifed & Delete Existing Record");
	gotoxy(10+35,14);
	printf("=> We Can Also Search medicines ,Customer,Supplier Details");
	gotoxy(10+35,16);
...
//======================Remainder for book stock ===============
void remainder()
{
    conn=mysql_init(0);
    conn=mysql_real_connect(conn,"localhost","root","","ds",0,NULL,0);

	query="select * from medicial where quantity <5;";
...
//cout<<query;
	...
	while(row=mysql_fetch_row(res))
	{
			...
			cout<<"  Quantity of "<<row[1]<<" is less then 5";
...
//struct date d;
    ...
    struct tm * now = localtime( & td );
	   ...
	   gotoxy(7+35,12);
	   printf("Sr.No   medicines Name       Qty          Rate       Total ");
	   gotoxy(6+35,14);
	   printf("---------------------------------------------------------------------");
      ...
      qstate=mysql_query(conn,q2);
         ...
         const char *q3=query.c_str();
           qstate=mysql_query(conn,q3);
			...
			box1();
			gotoxy(20+35,20);
			printf("medicines Added sucessfully!!!!!!");
			gotoxy(20+35,25);
			printf("More entries  [y/n]");
			ch=toupper(getche());
            if(ch=='Y')
...
void medi_sale()
{
  ...
  y=now->tm_year;
		...
		gotoxy(9+35,7);
		printf("ENTER BOOK ID TO BE SOLD  : ");
        cin>>tar;
		j=0;
...
void medi_search()
{
  ...
  system("cls");
	   ...
	   gotoxy(10+35,7);
	   printf("Enter medicines Id to be searched : ");
	   cin>>mid;
	   system("cls");
	   box();
	   lbox();
	   ...
	   printf(" BOOK ");
        i=16;
	   gotoxy(9+35,12);
	   printf("ID. BOOK NAME.   QTY   Supplier_Name   Man.Date     Exp.Date");
	   gotoxy(9+35,14);
	   printf("==================================================================\n");
  ...
  int i,c;
    ...
    conn=mysql_real_connect(conn,"localhost","root","","ds",0,NULL,0);
	   ...
	   do
	   {
		...
		gotoxy(10+35,42);
		printf("Press [1] for Update medicines Stock  & [0] for main menu ");
		c = (getche());
		switch (c)
		{
			case '0':animation();
...
void sale_rpt()
{
  ...
  conn=mysql_init(0);
    conn=mysql_real_connect(conn,"localhost","root","","ds",0,NULL,0);
	   ...
	   printf("Sales Report");
      gotoxy(7+35,10);
	   printf("ID. medicines Name.  Customer Name.   Qty.  Rate.  Total.   Date");
	   gotoxy(7+35,12);
	   printf("===================================================================");
...
void profit_rpt()
{
  ...
  conn=mysql_init(0);
    conn=mysql_real_connect(conn,"localhost","root","","ds",0,NULL,0);
      ...
      gotoxy(7+35,10);
	   printf("ID. medicines Name.   Date        Qty.  Unit Price  Sale Price. Profit. ");
	   gotoxy(7+35,12);
	   printf("===================================================================");
...
void pur_rpt()
{
  ...
  conn=mysql_init(0);
    conn=mysql_real_connect(conn,"localhost","root","","ds",0,NULL,0);
      ...
      gotoxy(7+35,10);
	 printf("ID. medicines Name.  Supplier Name.   Qty.  Rate.  Total.   Date");
	   gotoxy(7+35,12);
	   printf("===================================================================");
